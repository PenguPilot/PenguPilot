...
class ARCADE_Common(object):
   ...
   def __init__(self, cap):
      ...
      marg_orientation = AxisAngle(0, 0, 1, pi / 2)
      self.marg = DrotekMARG(self.i2c_bus, marg_orientation)
...
class ARCADE_Quad(ARCADE_Common):
   ...
   def __init__(self, motor_type, cap):
      ...
      # inverse coupling:
      self.inv_coupling = QuadInvCoupling(0.2025, 1.5866e-007, 4.0174e-009)
