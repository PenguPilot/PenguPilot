 ...
 */
float f2e_mk12_roxxy282735_1045(float force, float volt)
{
   float a = 609.6137f;
   float b = 1.3154f;
   float c = -1.5f;
 ...
 * Propeller: 10x4.5 inch
 */
float f2e_hk20_roxxy282735_1045(float force, float volt)
{
   if (force < 0.0f)
      return 0.0f;
 ...
 * Propeller: 10x4.5 inch
 */
float f2e_hexfet20_suppo221213_1045(float force, float volt)
{
   if (force < 0.0f)
      return 0.0f;
